...
export type _IpcParamsContracts = {
  ...
  chat_session_list: Expect<Assignable<ParamsOf<"chat_session_list">, IpcCommandMap["chat_session_list"]["params"]>>;
  chat_session_get: Expect<Assignable<ParamsOf<"chat_session_get">, IpcCommandMap["chat_session_get"]["params"]>>;
...
export type _IpcResponseContracts = {
  ...
  chat_session_list: Expect<Assignable<ResponseOf<"chat_session_list">, IpcCommandMap["chat_session_list"]["response"]>>;
  chat_session_get: Expect<Assignable<ResponseOf<"chat_session_get">, IpcCommandMap["chat_session_get"]["response"]>>;
