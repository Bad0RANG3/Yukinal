 ...
 *    的东西（`McpStdioConfig` 拒绝它，理由见仓库 `docs/boundaries/mcp.md`「边界：外部工具（MCP）」：出站网络策略还没有）。所以这里没有
        ...
        >
          ...
          <div className="settings-field">
            ...
            <p className="form-hint">
              ...
              目前<strong>不提供 http 传输</strong> —— 那需要出站网络策略，而它还不存在（见仓库 `docs/boundaries/mcp.md`「边界：外部工具（MCP）」），
